...
#def fill_states_actions_rewards(self, state_binary_ascii, code_action, reward): 
    ...
    #ai.fill_states_actions_rewards(b'A1B2E3E4E5F0', {103:1, 203:-1})
    ai.fill_states_actions_rewards(b'A1B2E3E4E5F0', 103,-1)
    ai.fill_states_actions_rewards(b'A1B2E3E4E5F0', 5004,1)
    ...
    for code_action in ai.states_actions[state_now]:
        ...
        returned_rewards.append(some_reward)

    
    for i in range(len(ai.states_actions[state_now])):
        ai.fill_states_actions_rewards(state_now,ai.states_actions[state_now][i], returned_rewards[i])

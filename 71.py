...
class Brain():
    ...
    def get_possible_first_tables(self, tabloids):
    	...
    	#int_from_base2
    	# 29501502363495303020746997618248286084663904731154492874738741508274635687472

    	# 29501502363495303020746997618248286084663904731154492874738741508274635687472:{actionX:rewardY,actionI:rewardJ}
...
while AGAIN:
    ...
    for player in Players:
        ...
        if player.human is False and player.alive is True:
            ...
            print(f"\n\n -_-_-_-        ai.states_actions  {ai.states_actions_rewards}  \n\n")
